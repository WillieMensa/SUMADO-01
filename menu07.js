...
function GenJuego()
{
	var aVertex = undefined;

	//	generar o leer datos de los vértices
	//	por ahora 'hard coded' para probar
	aVertex = [1, 6, 9, 8, 7, 4, 5, 2, 3]
	aOrden = [ randomInt(1,9), randomInt(1,9), randomInt(1,9), randomInt(1,9), randomInt(1,9), randomInt(1,9), randomInt(1,9), randomInt(1,9), randomInt(1,9)]
