...
function HaceBotones() {
	...
	BotonSalir.press = function () { Menu() };
...
function GenJuego()
{
	...
	//	console.log( "---------despues del ordenamiento-----------" );
	//	if (DEBUG) 
	//	{
	//		//	muesro los datos hasta aqui
	//		for (i = 0; i < 9 ; i++ )
	//		{
	//			//	console.log( "elemento " + i + " : " + aVertex[ i][0 ] + " , " + aVertex[i][1]  + " --- " + aVertex[i] );
	//			console.log( "elemento " + i + " : " + aVertex[ i] + " | "  );
	//		}
	//	}
	...
	aSumaPolig = [
		aVertices[0][1]+ aVertices[1][1]+ aVertices[4][1],
		aVertices[0][1]+ aVertices[3][1]+ aVertices[4][1],
		aVertices[1][1]+ aVertices[2][1]+ aVertices[4][1]+ aVertices[5][1],
		aVertices[3][1]+ aVertices[4][1]+ aVertices[6][1]+ aVertices[7][1],
		aVertices[4][1]+ aVertices[5][1]+ aVertices[8][1],
		aVertices[4][1]+ aVertices[7][1]+ aVertices[8][1]
	];
...
function end() {
	...
	EscenaDeJuego.removeChildren ( 0, 9 )
