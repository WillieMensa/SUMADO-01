...
//	Tarea actual
//	1	Preparación de un vector con la data de los vértices: (linea 126)
...
function setup() {
	...
	var message = new PIXI.Text( "A", { font: "56px Calibri", fill : "green", align : 'right'});
	message.position.set(210, 140);
	stage.addChild(message);

	message = new PIXI.Text(	"B", {font: "56px Calibri", fill : "green", align : 'right'});
	message.position.set(140, 205);
	stage.addChild(message);

	message =	new PIXI.Text(	"C", {font: "56px Calibri", fill : "green", align : 'right'});
	message.position.set(370, 170);
	stage.addChild(message);

	message = new PIXI.Text(	"D", {font: "56px Calibri", fill : 'green', align : 'center'});
	message.position.set(170, 370);
	stage.addChild(message);

	message = new PIXI.Text(	"F", {font: "56px Calibri", fill : 'green', align : 'center'});
	message.position.set(340, 405);
	stage.addChild(message);

	message = new PIXI.Text(	"E", {font: "56px Calibri", fill : 'green', align : 'center'});
