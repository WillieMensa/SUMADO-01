...
function setup() {
	...
	message = new PIXI.Text(	"B9", {font: "56px Calibri", fill : "green", align : 'right'});
	message.position.set(140, 205);
	stage.addChild(message);

	message =	new PIXI.Text(	"C9", {font: "56px Calibri", fill : "green", align : 'right'});
	message.position.set(370, 170);
	stage.addChild(message);

	message = new PIXI.Text(	"D9", {font: "56px Calibri", fill : 'green', align : 'center'});
	message.position.set(170, 370);
	stage.addChild(message);

	message = new PIXI.Text(	"E9", {font: "56px Calibri", fill : 0x10ff10, align : 'center'});
	message.position.set(340, 405);
	stage.addChild(message);

	message = new PIXI.Text(	"F9", {font: "56px Calibri", fill : 0x10ff10, align : 'center'});
